...
// POST "系统管理" => "部门管理"=>"国家"
export const supportcountry = () => post('admin/system/employee/support/country');
...
//post "财务管理" => "自动打款"
export const autuWithdraw = data => post('admin/finance/withdraw-record/autuWithdraw', data);
...
//POST获取 "法币管理"=>"币种管理"=>"获取所有币种"
export const getAllCoin = data => post('admin/system/coin/all', data);
...
//POST获取 "推荐返佣"=>"奖励记录"
export const rewardRecord = data => post('admin/promotion/reward-record/page-query ', data);


//POST获取 "推荐返佣"=>"vip申请"
export const vipApply = data => post('/admin/vipApply/page', data);

//POST获取 "推荐返佣"=>"vip申请查看"
export const vipApplyDetail = data => post('/admin/vipApply/detail', data);

//POST获取 "推荐返佣"=>"vip申请-查询VIP审核状态列表"
export const vipApplyStatus = data => post('/admin/vipApply/get-search-status', data);

//POST获取 "推荐返佣"=>"vip申请-审核"
export const vipApplyAudit = data => post('/admin/vipApply/audit', data);

//POST获取 "推荐返佣"=>"vip管理列表"
export const vipGrade = data => post('/admin/vipGrade/page', data);

//POST获取 "财务管理"=>"创建锁仓"
export const lockPositionCreate = data => post('/admin/lockPosition/create', data);



//POST获取 "财务管理"=>"币种"
export const coinAll = () => post('/admin/system/coin/all');
...
//POST获取 "系统管理" => "币种管理" => "添加币种钱包"
export const addCoinWallet = data => fetch('admin/system/coin/create-member-wallet', data);

//POST获取 "系统管理" => "币种管理" => "添加币种钱包"
export const ifExistWallet = data => fetch('admin/system/coin/need-create-wallet', data);


//Post '渠道'=》‘查看当前渠道’
export const channelList = data => post('admin/channel/list', data);

//Post '渠道'=》‘设置渠道’
export const channelSetUp = data => post('admin/channel/setUp', data);

//Post '渠道'=撤销某个渠道
export const channelRevoke = data => post('/admin/channel/revoke', data);
